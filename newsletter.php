...
if ($result !== false) {
    ...
    $message .= "---\n";
    $message .= "This is an automated notification from travel.gtr.lv newsletter subscription system.";
    
    $headers = "From: newsletter@travel.gtr.lv\r\n";
    $headers .= "Reply-To: newsletter@travel.gtr.lv\r\n";
